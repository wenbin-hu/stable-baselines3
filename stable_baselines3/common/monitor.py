...
class Monitor(gym.Wrapper):
    ...
    def __init__(
        ...
        self.rewards = None
        self.rewards_rot, self.rewards_pos, self.rewards_vel, self.rewards_time, self.rewards_con = None, None, None, None, None
    ...
    def reset(self, **kwargs) -> GymObs:
        ...
        self.rewards = []
        self.rewards_rot, self.rewards_pos, self.rewards_vel, self.rewards_time, self.rewards_con = [], [], [], [], []
    ...
    def step(self, action: Union[np.ndarray, int]) -> GymStepReturn:
        ...
        self.rewards_vel.append(info["r_vel"])
        ...
        if done:
            ...
            ep_rew_vel = sum(self.rewards_vel)
...
class ResultsWriter:
    ...
    def __init__(
        ...
        self.logger = csv.DictWriter(self.file_handler, fieldnames=("r", "l", "t", "r_pos", "r_rot", "r_vel", "r_time", "r_con") + extra_keys)
